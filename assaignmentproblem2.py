...
# queue.append((i1,j1,0,start_value)) # 0 means skipping number * and last part means coin collected
...
#         x,y,skip_use,collect_coin=queue.popleft()
#         if (x,y)==(i2,j2):
#             max_coins=collect_coin
#             found=True
#             break 
#         for dx,dy in dirs:
#             nx,ny=x+dx,y+dy
...
#                         queue.append((nx,ny,skip_use+1,collect_coin))
#                 else:
#                     value=int(cell)
#                     if not visited[nx][ny][skip_use]:
#                         visited[nx][ny][skip_use]=True
#                         queue.append((nx,ny,skip_use,collect_coin+value)) 
